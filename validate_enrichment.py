...
CRITICAL: Generate Bio and My take primarily from the festival bio provided. Only leave empty if the festival bio provides no useful information. DO NOT hallucinate demographics - only answer if you know for certain."""
    else:
...
CRITICAL: If you cannot find reliable information about this artist, leave Bio, My take, and My rating EMPTY. DO NOT hallucinate or guess."""
