...
python scripts/fetch_festival_data.py --festival rock-werchter --year 2026 --artist "Artist Name"

# Optional: Re-scrape only schedule fields (Date, Start Time, End Time, Stage) without touching bios or images
python scripts/fetch_festival_data.py --festival rock-werchter --year 2026 --schedule-only

# 3. Enrich artist data with AI-generated insights
python scripts/enrich_artists.py --festival rock-werchter --year 2026 --ai

# Optional: Enrich artist data with AI-generated insights for a specific artist   
python scripts/enrich_artists.py --festival rock-werchter --year 2026 --ai --artist "Artist Name"

# Optional: Manually enrich artist data interactively (prompts for missing fields)
python scripts/manual_enrich_artists.py --festival rock-werchter --year 2026
...
python scripts/helpers/generate_taglines.py --festival rock-werchter --year 2026
```
...
python scripts/generate_timetable.py --festival rock-werchter --year 2026

# Generate the About page with statistics
python scripts/generate_about.py --festival rock-werchter --year 2026

# Generate About page with AI-generated profile
python scripts/generate_about.py --festival rock-werchter --year 2026 --ai
```
...
.\\scripts\\regenerate_festival.ps1 -Festival rock-werchter -Year 2026
```
