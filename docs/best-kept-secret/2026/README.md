...
python scripts/fetch_festival_data.py --festival best-kept-secret --year 2026 --schedule-only
...
python scripts/enrich_artists.py --festival best-kept-secret --year 2026 --ai --artist "Artist Name"
...
python scripts/helpers/translate_festival_bios.py --festival best-kept-secret --year 2026

# Optional: Generate taglines for artists that don't have one yet (requires Azure OpenAI credentials)
python scripts/helpers/generate_taglines.py --festival best-kept-secret --year 2026
```
...
python scripts/generate_timetable.py --festival best-kept-secret --year 2026
