...
python scripts/scrape_festival.py lowlands --year 2026

# 1. Fetch Spotify links for all artists
python scripts/fetch_spotify_links.py --festival lowlands --year 2026

# 2. Fetch festival bios and social links from individual artist pages
python scripts/fetch_festival_data.py --festival lowlands --year 2026

# Optional: Fetch bio for a single artist (useful for testing or updates)
python scripts/fetch_festival_data.py --festival lowlands --year 2026 --artist "Artist Name"

# Optional: Re-scrape only schedule fields (Date, Start Time, End Time, Stage) without touching bios or images
python scripts/fetch_festival_data.py --festival lowlands --year 2026 --schedule-only

# 3. Enrich artist data with AI-generated insights
python scripts/enrich_artists.py --festival lowlands --year 2026 --ai

# Optional: Enrich artist data with AI-generated insights for a specific artist   
python scripts/enrich_artists.py --festival lowlands --year 2026 --ai --artist "Artist Name"

# Optional: Manually enrich artist data interactively (prompts for missing fields)
python scripts/manual_enrich_artists.py --festival lowlands --year 2026

# Optional: Manually enrich a specific artist
python scripts/manual_enrich_artists.py --festival lowlands --year 2026 --artist "Artist Name"

# Optional: Translate Dutch festival bios to English (requires Azure OpenAI credentials)
python scripts/helpers/translate_festival_bios.py --festival lowlands --year 2026

# Optional: Generate taglines for artists that don't have one yet (requires Azure OpenAI credentials)
python scripts/helpers/generate_taglines.py --festival lowlands --year 2026
```
...
python scripts/generate_html.py --festival lowlands --year 2026

# Generate individual artist pages with images
python scripts/generate_artist_pages.py --festival lowlands --year 2026

# Generate the timetable (schedule) HTML page
python scripts/generate_timetable.py --festival lowlands --year 2026

# Generate the About page with statistics
python scripts/generate_about.py --festival lowlands --year 2026

# Generate About page with AI-generated profile
python scripts/generate_about.py --festival lowlands --year 2026 --ai
```
...
python scripts/generate_spotify_playlists.py --festival lowlands --year 2026
```
...
.\\scripts\\regenerate_festival.ps1 -Festival lowlands -Year 2026
```
