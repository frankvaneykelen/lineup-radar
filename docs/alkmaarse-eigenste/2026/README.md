...
python scripts/scrape_festival.py --festival alkmaarse-eigenste --year 2026
...
python scripts/enrich_artists.py --festival alkmaarse-eigenste --year 2026
...
python scripts/manual_enrich_artists.py --festival alkmaarse-eigenste --year 2026 --artist "Artist Name"
```
...
python scripts/generate_html.py --festival alkmaarse-eigenste --year 2026
...
python scripts/generate_about.py --festival alkmaarse-eigenste --year 2026 --ai
```
