...
python scripts/fetch_festival_data.py --festival down-the-rabbit-hole --year 2026 --schedule-only
...
.\\scripts\\regenerate_festival.ps1 -Festival down-the-rabbit-hole -Year 2026
```
