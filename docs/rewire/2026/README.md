...
**Festival Dates:** April 09-12, 2026  
**Location:** TBD
...
python scripts/generate_html.py --festival rewire --year 2026
...
python scripts/generate_about.py --festival rewire --year 2026 --ai
```
...
python scripts/generate_spotify_playlists.py --festival rewire --year 2026
```
...
.\\scripts\\regenerate_festival.ps1 -Festival rewire -Year 2026
```
