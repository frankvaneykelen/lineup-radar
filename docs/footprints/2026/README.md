...
python scripts/scrape_festival.py --festival footprints --year 2026
...
python scripts/fetch_festival_data.py --festival footprints --year 2026 --artist "Artist Name"

# Enrich artist data with AI-generated insights
python scripts/enrich_artists.py --festival footprints --year 2026
...
python scripts/generate_about.py --festival footprints --year 2026
...
.\scripts\regenerate_festival.ps1 -Festival footprints -Year 2026
```
