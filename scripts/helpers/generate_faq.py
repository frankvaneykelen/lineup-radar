            ...
            <div class="row justify-content-center">
                <div class="col-lg-8 col-md-10">
                    <div>
                        ...
                        <!-- Analytics & Privacy -->
                        <div class="faq-item" style="margin-bottom: 2rem;">
                            <h3 style="color: #00a8cc; font-size: 1.2em; margin-bottom: 0.5rem;">Is your web analytics public too?</h3>
                            <p>Yes! You can view real-time and historical analytics for LineupRadar at <a href="https://frankvaneykelen-umami-app.azurewebsites.net/share/m1UIbU8KTTeZQ1Th" target="_blank" style="color: #00d9ff;">this public Umami dashboard</a>. We use Umami Analytics, which is GDPR-friendly and does not use cookies or collect personal data. All analytics are fully anonymized and privacy-respecting.</p>
                        </div>
